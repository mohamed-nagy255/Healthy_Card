...
?>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-12">
            <div class="links-profile">
              <a href="./profile-pharmacist.php" class="active"
                >profile <i class="fa-solid fa-right-long"></i
              ></a>
              <a href="./edit-profile-pharmacist.php?id=<?= $name['id'] ?>"
    ...
    <div class="wraper change-password-popup">
      <div class="popup">
        ...
        <form method="post" action="../functions/pharmacist/passpharmacist.php">
