...
<!-- End inclode Header -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Managers Tables</h1>
  ...
  <?php
      ...
      if (!isset($_GET['action'])) {
        include "design/manager/managerTable.php";
      } elseif ($_GET['action'] == 'add') {
        include "design/manager/addManagerForm.php";
      } elseif ($_GET['action'] == 'edite') {
        include "design/manager/editeManagerForm.php";
      }
