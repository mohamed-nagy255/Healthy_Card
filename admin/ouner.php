...
<!-- End inclode Header -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Ouner</h1>
...
<?php
  ...
  if (!isset($_GET['action'])) {
    include "design/ouner/ounerTable.php";
  } elseif ($_GET['action'] == 'add') {
    include "design/ouner/addOunerForm.php";
  } elseif ($_GET['action'] == 'edite') {
    include "design/ouner/editeOunerForm.php";
  }
