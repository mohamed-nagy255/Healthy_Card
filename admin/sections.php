...
<!-- End inclode Header -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Specialty Tables</h1>
       ...
       <?php
        ...
        if (!isset($_GET['action'])) {
          include "design/section/sectionTable.php";
        } elseif ($_GET['action'] == 'add') {
          include "design/section/addSectionForm.php";
        } elseif ($_GET['action'] == 'edite') {
          include "design/section/editeSectionForm.php";
        }
