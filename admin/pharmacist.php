...
<!-- End inclode Header -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Pharmacist</h1>
          ...
          <?php
            ...
            if (!isset ($_GET['action'])) {
              include "design/pharmacist/pharTable.php";
            } elseif ($_GET['action'] == 'add') {
              include "design/pharmacist/addpharForm.php";
            } elseif ($_GET['action'] == 'edite') {
              include "design/pharmacist/editpharForm.php";
            };
