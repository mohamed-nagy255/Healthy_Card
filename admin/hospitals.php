...
<!-- End inclode Header -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Hospital Tables</h1>
...
<?php
    ...
    if (!isset ($_GET['action'])) {
      include "design/hospital/hospitaltable.php";
    } elseif ($_GET['action'] == 'add') {
      include "design/hospital/addhospform.php";
    } elseif ($_GET['action'] == 'edite') {
      include "design/hospital/edithospform.php";
    }
