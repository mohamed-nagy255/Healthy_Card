...
<!-- End inclode Header -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Nurses Table</h1>
...
<?php
    ...
    if (!isset($_GET['action'])) {
      include "design/nurse/nurTable.php";
    } elseif ($_GET['action'] == 'add') {
      include "design/nurse/addNurForm.php";
    } elseif ($_GET['action'] == 'edite') {
      include "design/nurse/editNurForm.php";
    }
