...
<html lang="en">
  ...
  <body class="changeColor">
    <nav>
      ...
      <div class="btn-group login-patient">
        <img
        ...
        <ul class="dropdown-menu">
          <li>
            <a class="dropdown-item" href="./edit-profile-patient.php"
              ><i class="fa-solid fa-gear"></i> account setting</a
            >
          </li>
          <li>
            <a class="dropdown-item" href="./profile-patient.php"
              ><i class="fa-solid fa-user"></i> my profile</a
            >
          </li>
          <li><hr class="dropdown-divider" /></li>
          <li>
            <a class="dropdown-item log-out" href="#"
        ...
        <div class="row">
          <div class="col-lg-3 col-md-12">
            <div class="links-profile">
              <a href="./profile-patient.php?id=<?= $name['id']?>"
                >profile <i class="fa-solid fa-right-long"></i
              ></a>
              <a href="./edit-profile-patient.php" class="active"
...
require_once "../functions/connect.php";
$id_pat     =   $_GET['id'];
$select     =   "SELECT * FROM patients WHERE id = '$id_pat'";
...
?>
            <div class="user-info">
              <div class="main-data row">
                <div class="img-user col-sm-12">
                  <img
                    ...
                    id="user_img"
                  />
                  <form  method="post" action="../functions/patient/editpat.php">
                  <input
                    type="file"
                    title="search image"
                    id="file"
              ...
              <div class="full-input">
                ...
                <input type="text" name="username" value="<?php echo $pat['username']?>" />
              </div>
              <div class="full-input">
                <label for="">age: *</label>
                <input type="text" name="age" value="<?php echo $pat['age']?>"/>
              </div>
              <div class="full-input">
                <label for="">address: *</label>
                <input type="text" name="address" value="<?php echo $pat['address']?>"/>
              </div>
              <div class="full-input">
                <label for="">phone: *</label>
                <input type="text" name="phone" value="<?php echo $pat['phone']?>"/>
              </div>
